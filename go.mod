module github.com/kyawmyintthein/twirp-api-gateway-poc
...
require (
	...
	github.com/kyawmyintthein/lura-twirp v0.0.11
	github.com/kyawmyintthein/protoc-gen-twirplura v0.0.6
